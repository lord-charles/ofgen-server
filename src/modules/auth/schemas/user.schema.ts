...
export class User {
  ...
  @ApiProperty({ description: 'User password (hashed)', example: 'h$shedP@sswOrd' })
  @Prop({ required: true, select: false })
  password: string;

  @ApiProperty({ description: 'Password reset PIN', example: '123456', required: false })
  @Prop({ type: String, required: false, select: false })
  resetPasswordPin?: string;

  @ApiProperty({ description: 'Expiry date for password reset PIN', required: false })
